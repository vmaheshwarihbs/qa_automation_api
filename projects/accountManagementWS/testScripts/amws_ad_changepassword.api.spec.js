const superTest = require('supertest'),
    ...
    data = require('../testData/amws_ad_changepassword'),
    Joi = require('joi');
jest.setTimeout(100000);

describe('AWMS- AD Change Password', () => {

    it('TC-001 - ad change password - should change the password with 200 status code', (done) => {
    ...
    it('TC-002 - ad changepassword invalid input - should not change the password with 400 status code', (done) => {
    ...
    it('TC-003 - ad personsearch - should return correct content-type and schema in JSON format', (done) => {
