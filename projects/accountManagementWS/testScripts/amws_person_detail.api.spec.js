const superTest = require('supertest'),
    ...
    data = require('../testData/amws_person_detail'),
    Joi = require('joi');
...
describe('AMWS- Person Detail', () => {
    ...
    it('TC-001 - persondetails,it should return person detail with 200 status code', (done) => {
    ...
    it('TC-002 - persondetails,it should not return person detail with 400 status code', (done) => {
    ...
    it('TC-003 - persondetail - should return correct content-type and schema in JSON format', (done) => {
