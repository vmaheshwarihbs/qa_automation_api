const superTest = require('supertest'),
    ...
    data = require('../testData/amws_person_search'),
    Joi = require('joi');
jest.setTimeout(100000);

describe('AWMS- Person Search', () => {
    ...
    it('TC-002 - personsearch invalid input - should not return a person with 400 status code', (done) => {
        request.post(data.TC002.endpoint)
            .send({"personId" : "nbn289087600"})
            // .set("HBS_PERSON_ID", data.TC001.personId)
            .set("Content-Type", "application/json")
            .set("accept", "application/json")
            .end((err, res) => {
    ...
    it('TC-003 - personsearch - should return correct content-type and schema in JSON format', (done) => {
