const superTest = require('supertest'),
    ...
    data = require('../testData/alps_getCompletionStatusV2'),
    Joi = require('joi');
...
describe('GET_Completion StatusV2', () => {
    ...
    it('TC-001 - getCompletionStatusV2 - should return person alumni status with 200 status code', (done) => {
    ...
    it('TC-002 - getCompletionStatusV2 - should not return person alumni status with 404 status code', (done) => {
