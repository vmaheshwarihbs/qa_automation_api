const superTest = require('supertest'),
    ...
    data = require('../testData/alps_getMe'),
    Joi = require('joi');
...
describe('GET_Me', () => {
    ...
    it('TC-001 - getMe - should return person alumni status with 200 status code', (done) => {
    ...
    it('TC-002 - getMe - should not return person alumni status with 400 status code', (done) => {
