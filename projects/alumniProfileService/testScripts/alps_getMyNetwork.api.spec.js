const superTest = require('supertest'),
    ...
    data = require('../testData/alps_getMyNetwork'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('GET_MyNetwork', () => {

    it('TC-001 - getMyNetwork - should return person alumni result with 200 status code', (done) => {
    ...
    it('TC-002 - getMyNetwork - should not return class volunteers with 400 status code', (done) => {
    ...
    it('TC-003 - getMyNetwork - should return correct content-type and schema in JSON format', (done) => {
