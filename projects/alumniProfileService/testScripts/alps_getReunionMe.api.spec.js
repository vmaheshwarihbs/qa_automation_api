const superTest = require('supertest'),
    ...
    data = require('../testData/alps_getReunionMe'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('GET_ReunionMe', () => {

    it('TC-001 - getReunionMe - should return person reunion status with 200 status code', (done) => {
    ...
    it('TC-002 - getReunionMe - should return not person reunion status with 400 status code', (done) => {
        request.get(data.TC001.endpoint)
            .set("HBS_PERSON_ID", data.TC001.personId)
            .set("Content-Type", "application/json")
            .set("accept", "application/json")
