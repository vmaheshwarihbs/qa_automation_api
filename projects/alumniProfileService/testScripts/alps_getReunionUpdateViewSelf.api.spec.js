const superTest = require('supertest'),
    ...
    data = require('../testData/alps_getReunionUpdateViewSelf'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('GET_ReunionUpdateViewSelf', () => {

    it('TC-001 - getReunionUpdateViewSelf - should return updated reunion view with 200 status code', (done) => {
