const superTest = require('supertest'),
    ...
    data = require('../testData/alps_getRoles'),
    Joi = require('joi');
...
describe('GET_Roles', () => {
    ...
    it('TC-001 - getRoles - should return person vcard event with 200 status code', (done) => {
    ...
    it('TC-002 - getRoles - should return person vcard event with 200 status code', (done) => {
