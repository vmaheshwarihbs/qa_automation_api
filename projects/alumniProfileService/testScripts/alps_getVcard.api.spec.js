const superTest = require('supertest'),
    ...
    data = require('../testData/alps_getVcard'),
    Joi = require('joi');
...
describe('GET_Vcard', () => {
    ...
    it('TC-001 - getVcard - should return person alumni status with 200 status code', (done) => {
    ...
    it('TC-002 - getVcard - should not return person alumni status with 400 status code', (done) => {
    ...
    // it('TC-003 - getVcard - should return correct content-type and schema in JSON format', (done) => {
