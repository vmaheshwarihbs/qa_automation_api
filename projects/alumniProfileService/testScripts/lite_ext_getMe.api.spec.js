...
const superTest = require('supertest'),
    ...
    data = require('../testData/lite_ext_getMe'),
    Joi = require('joi');
...
describe('GET_Me', () => {
    ...
    it('TC-001 - getMe - should return person details status with 200 status code', (done) => {
    ...
    it('TC-002 - getMe - should not return person details status with 400 status code', (done) => {
    ...
    it('TC-003 - getMe - should return correct content-type and schema in JSON format', (done) => {
