const superTest = require('supertest'),
    ...
    data = require('../testData/lite_rest_getAlum'),
    Joi = require('joi');
...
describe('GET_Alum', () => {
    ...
    it('TC-001 - getAlum - should return person alumni result with 200 status code', (done) => {
    ...
    it('TC-002 - getAlum - should return person alumni result with 404 status code', (done) => {
    ...
    it('TC-003 - getAlum - should return correct content-type and schema in JSON format', (done) => {
