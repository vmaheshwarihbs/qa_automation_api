const superTest = require('supertest'),
    ...
    data = require('../testData/lite_rest_getCompletionStatus'),
    Joi = require('joi');
...
describe('GET_Completion Status', () => {
    ...
    it('TC-001 - getCompletionStatus - should return completion status status with 200 status code', (done) => {
    ...
    it('TC-002 - getCompletionStatus - should not return completion status status with 404 status code', (done) => {
