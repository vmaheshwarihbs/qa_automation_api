const superTest = require('supertest'),
    ...
    data = require('../testData/lite_rest_getReunionBookProgress'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('GET_ReunionBookProgress', () => {

    it('TC-001 - getReunionBookProgress - should return reunion book progress with 200 status code', (done) => {
    ...
    it('TC-002 - getReunionBookProgress - should return not person reunion book progress with 400 status code', (done) => {
    ...
    it('TC-003 - getReunionBookProgress - should return correct content-type and schema in JSON format', (done) => {
