const superTest = require('supertest'),
    ...
    data = require('../testData/lite_rest_getRoles'),
    Joi = require('joi');
...
describe('GET_Roles', () => {
    ...
    it('TC-001 - getRoles - should return person roles with 200 status code', (done) => {
    ...
    it('TC-002 - getRoles - should not return person roles event with 403 status code', (done) => {
    ...
    it('TC-003 - getRoles - should return correct content-type and schema in JSON format', (done) => {
