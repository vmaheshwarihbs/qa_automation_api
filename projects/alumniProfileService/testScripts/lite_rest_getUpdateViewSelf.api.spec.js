const superTest = require('supertest'),
    ...
    data = require('../testData/lite_rest_getUpdateViewSelf'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('GET_UpdateViewSelf', () => {

    it('TC-001 - getUpdateViewSelf - should return update view self with 200 status code', (done) => {
    ...
    it('TC-002 - getUpdateViewSelf - should not updated view  with 403 status code', (done) => {
    ...
    it('TC-003 - getUpdateViewSelf - should return correct content-type and schema in JSON format', (done) => {
