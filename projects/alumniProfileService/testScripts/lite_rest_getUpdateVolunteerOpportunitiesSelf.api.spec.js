const superTest = require('supertest'),
    ...
    data = require('../testData/lite_rest_getUpdateVolunteerOpportunitiesSelf'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('GET_UpdateVolunteerOpportunitiesSelf', () => {

    it('TC-001 - getUpdateVolunteerOpportunitiesSelf - should return updated volunteer opportunity self view with 200 status code', (done) => {
    ...
    it('TC-002 - getUpdateVolunteerOpportunitiesSelf - should return Update Volunteer Opportunities Self with 403 status code', (done) => {
    ...
    it('TC-003 - getUpdateVolunteerOpportunitiesSelf - should return correct content-type and schema in JSON format', (done) => {
