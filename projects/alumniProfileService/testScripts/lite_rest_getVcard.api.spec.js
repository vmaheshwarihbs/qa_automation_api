const superTest = require('supertest'),
    ...
    data = require('../testData/lite_rest_getVcard'),
    Joi = require('joi');
...
describe('GET_Vcard', () => {
    ...
    it('TC-001 - getVcard - should return person vcard with 200 status code', (done) => {
    ...
    it('TC-002 - getVcard - should not return person vcard  with 400 status code', (done) => {
