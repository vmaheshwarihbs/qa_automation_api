const superTest = require('supertest'),
    ...
    data = require('../testData/lite_rest_new_getMetaData'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('GET_New_MetaData', () => {

    it('TC-001 - new_getmetadata - should return new meta data with 200 status code', (done) => {
    ...
    it('TC-002 - new_getmetadata - should not return new meta data with 400 status code', (done) => {
    ...
    it('TC-003 - new_getmetadata - should return correct content-type and schema in JSON format', (done) => {
