const superTest = require('supertest'),
    ...
    data = require('../testData/p_ext_addToMyNetwork'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('Add_tomynetwork', () => {

    it('TC-001 - Add to my network - should return new meta data with 200 status code', (done) => {
        request.post(data.TC001.endpoint)
            // .send({"personId":949467})
