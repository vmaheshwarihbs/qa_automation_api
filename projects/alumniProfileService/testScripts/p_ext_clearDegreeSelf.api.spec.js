const superTest = require('supertest'),
    ...
    data = require('../testData/p_ext_clearDegreeSelf'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('clear Degree Self', () => {

    it('TC-001 - clear Degree Self - should return new meta data with 200 status code', (done) => {
