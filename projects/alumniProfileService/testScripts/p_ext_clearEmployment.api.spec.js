const superTest = require('supertest'),
    ...
    data = require('../testData/p_ext_clearEmploymentSelf'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('clearEmploymentSelf', () => {

    it('TC-001 -clear Employment Self - should clear address with 200 status code', (done) => {
