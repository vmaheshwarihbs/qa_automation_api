const superTest = require('supertest'),
    ...
    data = require('../testData/p_ext_clearSeasonalAddress'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('ClearSeasonalAddress', () => {

    it('TC-001 - clearSeasonalAddress - should clear seasonal address with 200 status code', (done) => {
