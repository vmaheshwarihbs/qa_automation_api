const superTest = require('supertest'),
    ...
    data = require('../testData/p_ext_getSuggestedClubs'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('get SuggestedClubs', () => {

    it('TC-001 - get Suggested Clubs - should return suggested clubs with 200 status code', (done) => {
