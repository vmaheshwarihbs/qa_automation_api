const superTest = require('supertest'),
    ...
    data = require('../testData/p_ext_updateContactEmail'),
    Joi = require('joi');
...
describe('updateBoardSelf', () => {
    ...
    it('TC-001 - updateBoardSelf - should update board self with 200 status code', (done) => {
        request.post(data.TC001.endpoint)
            ...
            .send({"categoryCode": "VIS","email": "kpaul@amp181stg.hbsstg.org","forwardingEmailNotHBS": true,"forwardingEmailNotHarvardPost": true,"primary": true})
