const superTest = require('supertest'),
    ...
    data = require('../testData/rest_getCompletionStatusV2'),
    Joi = require('joi');
...
describe('GET_Completion StatusV2', () => {
    ...
    it('TC-001 - getCompletionStatusV2 - should return completion status V2 status with 200 status code', (done) => {
    ...
    it('TC-002 - getCompletionStatusV2 - should not return completion status V2 with 404 status code', (done) => {
