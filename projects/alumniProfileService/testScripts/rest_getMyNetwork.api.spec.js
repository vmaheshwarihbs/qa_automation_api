const superTest = require('supertest'),
    ...
    data = require('../testData/rest_getMyNetwork'),
    Joi = require('joi');
...
describe('GET_MyNetwork', () => {
    ...
    it('TC-001 - getMyNetwork - should return my network result with 200 status code', (done) => {
    ...
    it('TC-002 - getMyNetwork - should not return my network result with 400 status code', (done) => {
