const superTest = require('supertest'),
    ...
    data = require('../testData/rest_getUpdateView'),
    Joi = require('joi');
jest.setTimeout(100000);



describe('GET_UpdateView', () => {

    it('TC-001 - getUpdateView - should return update view with 200 status code', (done) => {
    ...
    it('TC-002 - getUpdateView - should not return update view with 403 status code', (done) => {
    ...
    // it('TC-003 - getUpdateView - should return correct content-type and schema in JSON format', (done) => {
