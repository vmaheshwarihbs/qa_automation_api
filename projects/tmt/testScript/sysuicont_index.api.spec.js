const superTest = require('supertest'),
    ...
    data = require('../testData/sysuicont_index'),
    Joi = require('joi');
...
describe('GET_Index', () => {
    ...
    it('TC-001 - Index - should return index with 200 status code', (done) => {
    ...
    it('TC-002 - Index - should not return index with 403 status code', (done) => {
    ...
    it('TC-003 - Index - should return correct content-type and schema in JSON format', (done) => {
    ...
    it('TC-004 - Index - should return the response in sepecified time', (done) => {
    ...
    it('TC-005 - Index - should return status code 404 for access denied', (done) => {
