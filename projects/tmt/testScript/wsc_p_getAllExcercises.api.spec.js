...
const superTest = require('supertest'),
    ...
    data = require('../testData/wsc_p_getAllExcercises'),
    Joi = require('joi');
        ...
        request.post(data.TC006.endpoint)
            ...
            .end(async(err, res) => {
                ...
                try{
                   ...
                   fs.writeFileSync('./database_response/p_get_present.json', p_data);
                   let np_data = JSON.stringify(not_present);
                   fs.writeFileSync('./database_response/p_get_not_present.json', np_data);
                 }
                 catch (err) {
